    ...
    def delete_user_and_associated_instances(self, user_id):
        ...
        try:
            ...
            if places_ids_list:
                ...
                raise ValueError(f"No place found for this user")
...
# <------------------------------------------------------------------------>
    ...
    def delete_amenity_from_place_list(self, amenity_name, place_id):
        ...
        if amenity_name in place.amenities:
            place.amenities = [
                amty_name for amty_name in place.amenities
                if amty_name != amenity_name]
...
# # <------------------------------------------------------------------------>
    ...
    def delete_review_from_place_list(self, review_id, place_id):
        ...
        if review_id in reviews:
            place.reviews = [
                rev_id for rev_id in reviews if rev_id != review_id]
